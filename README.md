...
In the following chart are the results for deserialization. Here it is visible that for bid DataSets with changes the performance starts to fall behind the `BinaryFormater` and `DataContractSerializer` serialization.
